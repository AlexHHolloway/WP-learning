...
class MyNotes {
  ...
  async createNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + "/wp-json/wp/v2/note", newPost);
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.dataset.id, updatedPost);
  ...
  async deleteNote(e) {
    var thisNote = e.target.closest("li");
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.dataset.id);
